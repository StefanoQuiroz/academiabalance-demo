                    ...
                    <div className='col-xl-6 col-lg-6 wow fadeInRight'>
                        <div className='tf__faq_text'>
                            <div className='tf__heading_area tf__heading_area_left mb_25'>
                                ...
                                <h2>Todo lo que necesitas saber sobre nuestros servicios</h2>
                            </div>
                            <p className='description'>
                                Resolvemos tus dudas sobre nuestras clases de refuerzo universitario e idiomas. Encuentra la información que necesitas para
                                empezar tu formación con nosotros.
                            </p>
                                ...
                                <div className='accordion' id='accordionExample'>
                                    {faqData.map((item) => (
                                        <div className={`accordion-item ${item.color}`} key={item.id}>
                                            ...
                                            <div id='collapseOne' className={`accordion-collapse collapse ${openAccordion === item.id ? 'show' : ''}`}>
